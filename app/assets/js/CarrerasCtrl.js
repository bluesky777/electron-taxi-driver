...
app.controller("CarrerasCtrl", function(
  ...
  $scope.guardarcarrera = function(carrera_Editar) {
    ...
    hora_inicio 	= "" + carrera_Editar.fecha_ini.getHours() + ":" + carrera_Editar.fecha_ini.getMinutes(); //+ (carrera_nuevo.hora_ini.getHours() >= 12 ? "PM" : "AM");
    hora_final 		= "" + carrera_Editar.fecha_fin.getHours() + ":" + carrera_Editar.fecha_fin.getMinutes(); //+ (carrera_nuevo.hora_fin.getHours() >= 12 ? "PM" : "AM");
